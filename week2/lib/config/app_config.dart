...
class AppConfig {
  ...
  static const String appDescription = 'Comprehensive cybersecurity testing and education platform';
  ...
  static const List<String> allowedFileExtensions = ['.dart', '.py', '.js', '.ts'];
  ...
  static bool get isLargeScreen => 
      ...
      minScreenWidth * WidgetsBinding.instance.platformDispatcher.views.first.devicePixelRatio;
